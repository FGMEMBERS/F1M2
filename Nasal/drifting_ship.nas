...
var drift_ship = func { 
    ...
    var newlat = oldlat+latche*360.0/40000000;
    var newlon = oldlon+lonche*360.0/(math.cos(newlat*math.pi / 180.0)*40000000);
      print ("latche:" , latche," lonche:",lonche);
      print ("newlat:" , newlat," newlon:",newlon);
    var property_alt=getprop("/position/altitude-ft");
    var property_speed=getprop("/velocities/airspeed-kt");
    if (property_alt<5 and property_speed<10){
